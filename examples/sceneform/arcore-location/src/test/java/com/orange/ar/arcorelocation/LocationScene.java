...
import com.orange.ar.arcorelocation.sensor.DeviceOrientation;
...
import com.orange.ar.arcorelocation.sensor.DeviceLocation;
import com.orange.ar.arcorelocation.utils.LocationUtils;
...
public class LocationScene {
    ...
    public com.orange.ar.arcorelocation.sensor.DeviceLocation deviceLocation;
    public com.orange.ar.arcorelocation.sensor.DeviceOrientation deviceOrientation;
        ...
        for (LocationMarker locationMarker : mLocationMarkers) {
            ...
            try {
                ...
                int markerDistance = (int) Math.ceil(
                        com.orange.ar.arcorelocation.utils.LocationUtils.distance(
